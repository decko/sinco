...
from sinco.core.views import index, conselhos, conselho, conselheiro, rel_cargos_vagos, relatorio
...
urlpatterns = patterns('',
    ...
    url(r'^relatorios/dados_conselheiros/(?P<tipo>\d+)/$', relatorio, name="dados_conselheiros"),
